   ...
   <footer class="footer__section bg-secondary">
    <div class="container">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            <a class="footer__logo" href="index.html"><img class="footer__logo--img display-block" src="{{asset('app/img/logo/nav-logo-white.webp')}}" alt="footer-logo"></a>
...
{{-- 
                            ...
                            <div class="footer__social">
                                <ul class="social__shear d-flex">
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank" href="http://{{$appSetting->facebook ?? ''}}">
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank"  href="http://{{$appSetting->twitter ?? ''}}">
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank" href="http://{{$appSetting->instagram ?? ''}}">
                                    ...
                                    <li class="social__shear--list">
                                        <a class="social__shear--list__icon" target="_blank" href="http://{{$appSetting->youtube ?? ''}}">
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
            <p class="copyright__content  m-0">Copyright © 2022 <a class="copyright__content--link" href="index.html">As Yazılım</a> . All Rights Reserved.</p>
