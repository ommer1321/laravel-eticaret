        ...
        <div class="container-fluid width-100">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo main__logo--style2">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="{{asset('app/img/logo/nav-logo-white.webp')}}" alt="logo-img"></a></h1>
                </div>
                <div class="header__menu d-none d-lg-block">
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            <li class="header__menu--items style2">
                                <a class="header__menu--link style2" href="index.html">Home <span class="menu__plus--icon">+</span></a>
                            ...
                            <li class="header__menu--items mega__menu--items style2">
                                <a class="header__menu--link style2" href="shop.html">Shop <span class="menu__plus--icon">+</span></a>
                                <ul class="header__mega--menu d-flex">
                                    ...
                                    <li class="header__mega--menu__li fullscreen__style d-flex">
                                        <a class="header__mega--menu__banner" href="shop.html"><img class="header__mega--menu__banner--img" src="{{asset('app/img/other/mega-menu-banner.webp')}}" alt="banner-menu"></a>
                                        <a class="header__mega--menu__banner" href="shop.html"><img class="header__mega--menu__banner--img" src="{{asset('app/img/other/mega-menu-banner2.webp')}}" alt="banner-menu"></a>
                                    </li>

                                </ul>
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link style2" href="about.html">About US </a>  
                            </li>
                            <li class="header__menu--items style2">
                                <a class="header__menu--link style2" href="blog.html">Blog <span class="menu__plus--icon">+</span> </a>
                                <ul class="header__sub--menu">
                            ...
                            <li class="header__menu--items style2">
                                <a class="header__menu--link style2" href="#">Pages <span class="menu__plus--icon">+</span></a>
                                <ul class="header__sub--menu">
                            ...
                            <li class="header__menu--items style2">
                                <a class="header__menu--link style2" href="contact.html">Contact </a>  
                            </li>
                        </ul>
                    </nav>
                </div>
                <div class="header__account">
                    <ul class="d-flex">
                        <li class="header__account--items  header__account--search__items d-sm-2-none">
                            <a class="header__account--btn search__open--btn style2" href="javascript:void(0)" data-offcanvas>
                                <svg class="header__search--button__svg" xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"/></svg>  
                                <span class="visually-hidden">Search</span>
                            </a>
                        </li>
                        <li class="header__account--items">
                            <a class="header__account--btn minicart__open--btn style2" href="javascript:void(0)" data-offcanvas>
                    ...
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="language__currency--list">
                            <a class="offcanvas__account--currency__menu" href="#">
                                <img src="{{asset('app/img/icon/usd-icon.webp')}}" alt="currency">
                                <span>$ US Dollar</span> 
                                <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05" viewBox="0 0 9.797 6.05">
                                    <path  d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                </svg>
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumbnail">
                    <a href="product-details.html"><img src="{{asset('app/img/product/small-product1.webp')}}" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumbnail">
                    <a href="product-details.html"><img src="{{asset('app/img/product/small-product2.webp')}}" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
