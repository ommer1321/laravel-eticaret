                        ...
                        <div class="product__details--info">
                            <form action="#">
                                ...
                                <div class="guarantee__safe--checkout">
                                    <h5 class="guarantee__safe--checkout__title">Geçerli Kredi Kartları  </h5>
                                ...
                                <div id="reviews" class="tab_pane">
                                    <div class="product__reviews">
                                        <div class="product__reviews--header">
                                            <h2 class="product__reviews--header__title h3 mb-20">Müşteri Yorumları</h2>
                                            <div class="reviews__ratting d-flex align-items-center">
                                                ...
                                                <span class="reviews__summary--caption">Yorum Sayısı 2</span>
                                            </div>
                                    ...
                                    <div class="product__tab--conten">
                                        <div class="product__tab--content__step mb-30">
                                            <ul class="additional__info_list">
                                                ...
                                                <li class="additional__info_list--item">
                                                    <span class="info__list--item-head"><strong>Stok Sayısı</strong></span>
