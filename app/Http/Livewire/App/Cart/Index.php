...
{
    public $cart, $cartDetail, $cartItem, $cartItem_id, $quantity_val = 0, $cartAll;
    ...
    public function increment($cartItem_id)
    {
        ...
        $res =   $this->cartItem = Cart::where('id', $this->cartItem_id)->first();
        if ($res) {
    ...
    public function deleteAll()
    {
        ...
        $this->cartAll = Cart::where('user_id', auth()->user()->id)->get();

        foreach ($this->cartAll as $cart) {
